...
export default (props) => (
    <div class="max-w-sm bg-color-whiteish-darker shadow-lg rounded-lg overflow-hidden my-4">
        <img class="w-full h-56 object-cover object-center" src={props.imgsrc} alt="avatar"/>
        <div class="py-4 px-6">
            <h1 class="text-2xl font-semibold dark-reddish-text">{props.name}</h1>
            <p class="py-2 text-lg dark-reddish-text">{props.desc}</p>
            <div class="flex items-center mt-4 dark-reddish-text">
                ...
                <h1 class="px-2 text-sm">{props.team}</h1>
            </div>
            <div class="flex items-center mt-4 dark-reddish-text">
                <svg class="h-6 w-6 fill-current" viewBox="0 0 512 512">
